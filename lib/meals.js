...
const appendMeal = (meal) => {
  $('.meals').append(`<table id=${meal.id} class='meal-foods-table'>
                      ...
                      </table>`).append(mealFoods(meal)).append(`<tr><td class='total'>Total Calories: </td><td class='meal-calories'>${mealCalorieTotal(meal)}</tr>`)
}
...
const addCalTotal = (meal) => {
  `<tr><td class='total'>Total Calories: </td><td class='meal-calories'>${mealCalorieTotal(meal)}</tr>`
}
